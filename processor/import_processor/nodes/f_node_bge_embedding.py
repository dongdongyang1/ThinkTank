...
from processor.import_processor.exceptions import StateFieldError, EmbeddingError
...
class NodeBGEEmbedding(BaseNode):
    ...
    def process(self, state: ImportGraphState)->ImportGraphState:
        ...
        必要参数：chunks
        新参数：chunks字段新增dense_vector/sparse_vector
    ...
    def _step_1_validate_input(self, state:ImportGraphState)->List[Dict]:
        ...
        异常：
            chunks非列表/为空，抛出ValueError，终止当前向量化流程
        """
    ...
    def _step_2_generate_embeddings(self, chunks:List[Dict[str,str]]) -> List[Dict[str,str]]:
        ...
        for i in range(0,len(chunks),batch_size):
            ...
            try:
               ...
               raise  EmbeddingError("批量生成向量失败:"+str(e))
...
if __name__ == "__main__":
    ...
    json_path = r"D:\doc\hak180产品安全手册\chunks_item_name.json"
    ...
    result = node_bge_embedding(init_state)  #Python 字典对象

    result_json_str = json.dumps(result,ensure_ascii=False,indent=4)   #序列化转成 JSON 字符串

    save_path = r"D:\doc\hak180产品安全手册\state_vector.json"
