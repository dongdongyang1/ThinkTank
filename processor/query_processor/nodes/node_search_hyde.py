...
class NodeSearchHyde(BaseNode):
    ...
    def _step_2_search_embedding_hyde(self, rewritten_query:str, item_names:Optional[List[str]], hyde_doc:str):
        """
        ...
        try:
            ...
            # 4、过滤：处理 item_names 中的引号，防止注入或语法错误
            expr = None
            if item_names:
...
if __name__ == "__main__":
    ...
    node_search_hyde = NodeSearchHyde()
    result = node_search_hyde(init_state)
