...
def hybrid_search(client,collection_name,reqs,rank_weights=(0.5,0.5),norm_score=True,limit=5,output_fields=None,search_params=None):
    """
       执行Milvus稠密+稀疏向量混合搜索
    ...
    try:
        ...
        ranker = WeightedRanker(rank_weights[0],rank_weights[1],norm_score=norm_score)
        ...
        if res and len(res)>0:
            ...
            logger.warning(f"Milvus混合搜索完成，集合[{collection_name}]未检索到结果")
        return res
